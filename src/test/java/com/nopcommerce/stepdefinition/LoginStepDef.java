...
public class LoginStepDef {
    ...
    public void i_have_entered_a_valid_username_and_password() {
        loginPage.enterUsername("ridwan.test111@gmail.com");
    ...
    public void i_should_see_an_error_message_indicating(String errorMessage) {
        ...
        Assert.assertEquals( driver.findElement(By.xpath("//li[normalize-space()='No customer account found']")).isDisplayed(), true);
    }
    ...
    public void i_should_be_redirected_to_the_password_reset_page() {
        ...
        Assert.assertTrue(loginPage.getForgotPwdPageUrl().contains("passwordrecovery"));
    }
